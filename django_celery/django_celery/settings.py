...
SECRET_KEY = 'django-insecure-8_27%i_au0mnl6h@&js1=7xyhc8aj%!%gmn@e7tn87cfz%4@*r'
...
CELERY_RESULT_BACKEND = 'redis://127.0.0.1:6379/0' #Result Backend Redis
CELERY_TIMEZONE = "Asia/Kolkata"

## SET Celery BAckend As Django DB
...
# METHOD 1 OF Scheduling Task
CELERY_BEAT_SCHEDULE = {
    'every-10-seconds-task':{
        'task':'celery_app.tasks.first_shedule_task',
        'schedule':10,
        'args':('111',)
    }
}
